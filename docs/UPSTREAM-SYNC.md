...
| 9 | [`SYNC-P9-REGIONAL-MUTATION.md`](SYNC-P9-REGIONAL-MUTATION.md) | `#247`, `#249`, `#252`–`#254`, `#256`–`#258`, `#263`, `#264` | 5, 8, [**D-3**](#open-decisions) | ⚠️ Backend + read-only QML merged `9d4e4e1` (PR #32, 2026-09-16); **Settings UI wiring is the remaining scope**, planned in the doc's §5 and tracked on `sync-p9-settings-ui` as its own follow-up PR — Phase 6's system-management work is not done until it lands too; see `TASKS.md`, `CHANGELOG.md` |
