...
| 9 | [`SYNC-P9-REGIONAL-MUTATION.md`](SYNC-P9-REGIONAL-MUTATION.md) | `#247`, `#249`, `#252`–`#254`, `#256`–`#258`, `#263`, `#264` | 5, 8, [**D-3**](#open-decisions) | ✅ Backend + QML done, on `sync-p7-mutation-fix-v2`, pending review in PR #32 (2026-09-16); Settings UI wiring out of scope (see the note below); see `TASKS.md`, `CHANGELOG.md` |
