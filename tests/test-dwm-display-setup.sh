...
HELPER="$repo/scripts/dwm-display-setup"
SETTINGS_HELPER="$repo/scripts/dwm-settings-display"
...
grep -Fq 'Option "Monitor-HDMI-1" "lyona-HDMI-1"' "$work/generated-60.conf"
...
managed="$work/etc/X11/xorg.conf.d/90-lyona-display.conf"
...
mkdir -p "$work/home/.config/lyona/display-profiles"
cat >"$work/home/.config/lyona/display-profiles/legacy.conf" <<'EOF'
...
test -f "$work/home/.config/lyona/display-profiles/desk.conf"
...
test ! -e "$work/home/.config/lyona/display-profiles/unsafe-name.conf"
test -f "$work/runtime/dwm-settings-display/rollback-failure.previous"
