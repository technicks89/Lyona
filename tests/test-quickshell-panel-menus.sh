...
grep -Fq 'readonly property int panelHeight: dp(30)' "$core/Theme.qml"
...
grep -Fq 'text: root.powerMenuModel.pendingAction ? root.powerMenuModel.pendingAction.detail : ""' "$power/PowerMenuWindow.qml"
