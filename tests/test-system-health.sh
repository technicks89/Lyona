...
HELPER=$repo/scripts/dwm-system-health
make_workspace

mkdir -p "$work/bin" "$work/home/.config/lyona" "$work/home/.config/quickshell"
printf 'ID=arch\nPRETTY_NAME="Arch Linux Test"\n' >"$work/os-release"
: >"$work/home/.config/lyona/hotkeys.toml"
: >"$work/home/.config/lyona/themes.toml"
: >"$work/home/.config/lyona/window-rules.toml"
...
SCRIPT
chmod +x "$work/bin/pacman" "$work/bin/quickshell" "$work/bin/systemctl" "$work/bin/xclip"
