...
ClickAwayPopup {
    ...
    readonly property int cardWidth: Theme.dp(620)
    readonly property int cardHeight: Theme.dp(680)
    ...
    ShellSurface {
        ...
        FloatingWindow {
            ...
            implicitWidth: Math.min(Theme.dp(440), screen ? screen.width : Theme.dp(440))
            implicitHeight: Math.min(Math.max(Theme.dp(210),
                passwordColumn.implicitHeight + Theme.sectionSpacing * 2),
                screen ? screen.height : Theme.dp(210))
            ...
            Rectangle {
                ...
                Flickable {
                    ...
                    // A large desktop text scale can make the form taller than the
                    // screen; scroll rather than push the buttons off-screen.
                    contentWidth: Math.max(width, Theme.dp(440) - Theme.sectionSpacing * 2)
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            Layout.fillWidth: true
                            Layout.preferredHeight: Math.max(Theme.dp(44), Theme.inputFontSize + Theme.dp(20))
                            ...
                            ShellButton {
                                Layout.preferredWidth: Math.max(Theme.dp(62), implicitWidth)
                                Layout.fillHeight: true
