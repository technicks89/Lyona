    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                property var settings: root.settingsModel.inputSettingsFor(deviceCard.modelData.key)
                property var unsupported: root.settingsModel.inputUnsupportedFor(deviceCard.modelData.key)
