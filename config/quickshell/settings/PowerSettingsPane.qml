    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            UiText {
                ...
                color: Theme.statusColor(root.powerModel.providerState)
                font.bold: true
        ...
        UiText {
            ...
            color: Theme.statusColor(root.powerModel.profileState)
            wrapMode: Text.WordWrap
        }
        ...
        StatusCard {
            ...
            value: root.powerModel.dpmsEnabled ? Theme.formatDuration(root.powerModel.dpmsTimeout) : "Off"
        ...
        StatusCard {
            ...
            value: root.powerModel.lockEnabled ? Theme.formatDuration(root.powerModel.lockTimeout) : "Off"
